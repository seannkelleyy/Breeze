...
export const GET_EXPENSES_BY_BUDGET = `query GetExpensesByBudget($budgetId: ID!) {
  expenses(budgetId: $budgetId) { id userId budgetId amount date description splits { id categoryId amount description } sourceType sourceTemplateId generationMonth personId createdAt updatedAt }
}`;
export const CREATE_EXPENSE = `mutation CreateExpense($input: CreateExpenseInput!) {
  createExpense(input: $input) { id userId budgetId amount date description splits { id categoryId amount description } personId createdAt updatedAt }
}`;
export const UPDATE_EXPENSE = `mutation UpdateExpense($input: UpdateExpenseInput!) {
  updateExpense(input: $input) { id userId budgetId amount date description splits { id categoryId amount description } personId createdAt updatedAt }
}`;
...
export const GET_INCOMES_BY_BUDGET = `query GetIncomesByBudget($budgetId: ID!) {
  incomes(budgetId: $budgetId) { id userId budgetId name amount date sourceType sourceTemplateId sourceOccurrenceDate generationMonth personId createdAt updatedAt }
}`;
export const CREATE_INCOME = `mutation CreateIncome($input: CreateIncomeInput!) {
  createIncome(input: $input) { id userId budgetId name amount date sourceType sourceTemplateId sourceOccurrenceDate generationMonth personId createdAt updatedAt }
}`;
export const UPDATE_INCOME = `mutation UpdateIncome($input: UpdateIncomeInput!) {
  updateIncome(input: $input) { id userId budgetId name amount date sourceType sourceTemplateId sourceOccurrenceDate generationMonth personId createdAt updatedAt }
}`;
...
export const GET_RECURRING_EXPENSES = `query GetRecurringExpenses($userId: ID!) {
  recurringExpenses(userId: $userId) { id userId name amount recurrenceInterval paydayDayOfMonth startDate endDate personId createdAt updatedAt }
}`;
export const CREATE_RECURRING_EXPENSE = `mutation CreateRecurringExpense($input: CreateRecurringExpenseInput!) {
  createRecurringExpense(input: $input) { id userId name amount recurrenceInterval paydayDayOfMonth startDate endDate personId createdAt updatedAt }
}`;
export const UPDATE_RECURRING_EXPENSE = `mutation UpdateRecurringExpense($input: UpdateRecurringExpenseInput!) {
  updateRecurringExpense(input: $input) { id userId name amount recurrenceInterval paydayDayOfMonth startDate endDate personId createdAt updatedAt }
}`;
