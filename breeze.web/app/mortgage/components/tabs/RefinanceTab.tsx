      ...
      {homeLoan && baseLoanSummary && refinanceSummary ? (
        <>
          ...
          <div className="grid grid-cols-1 gap-3 text-sm sm:grid-cols-2 lg:grid-cols-3">
            ...
            <p>
              New payment: {formatCurrency(refinanceSummary.refinancePayment)}
              /mo
            </p>
            ...
            <p>
              Break-even:{' '}
              {refinanceSummary.breakEvenMonths !== null
                ? `${refinanceSummary.breakEvenMonths} months`
                : 'No break-even'}
            </p>
          ...
          <div className="space-y-1 rounded-md border p-3 text-sm">
            <p className="font-medium">
              Recommendation: {refinanceSummary.recommendationLabel} (score{' '}
              {refinanceSummary.recommendationScore})
            </p>
