...
export const useEnvironmentVariables = (): EnvironmentVariables => {
    ...
    const baseHostedUrl = getValue('BASE_HOSTED_URL', 'https://breeze.seannkelleyy/')
    const baseLocalLoginUrl = getValue('BASE_LOCAL_LOGIN_URL', 'http://localhost:5173/login')
    const baseHostedLoginUrl = getValue('BASE_HOSTED_LOGIN_URL', 'https://breeze.seannkelleyy.com/login')
