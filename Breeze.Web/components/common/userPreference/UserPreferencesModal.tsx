...
export const UserPreferencesModal = () => {
	const { currencyCode, setCurrencyCode, returnDisplayMode, setReturnDisplayMode, inflationRate, setInflationRate, safeWithdrawalRate, setSafeWithdrawalRate } = useCurrentUser()
