			...
			{homeLoan && baseLoanSummary ? (
				<>
					...
					<BreezeLineChart
						...
						leftAxis={{ dataKey: 'balance', yAxisId: 'left', tickFormatter: formatCompactAxisLabel }}
					...
					{baseLoanSummary.isNegativeAmortization ? <p className='text-xs text-destructive'>Current payment may not cover interest (negative amortization).</p> : null}
				</>
			) : null}
		</TabsContent>
	)
