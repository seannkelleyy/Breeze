...
import { RecurringCategoryTemplate, RecurringIncomeTemplate, ScheduleType, useRecurringTemplates } from '../../hooks/recurring/recurringTemplateServices'
						...
						{incomeTemplates.map((template, index) => {
							...
							return (
								<div
									...
									className='rounded-lg border p-4 bg-background/80'
								>
									...
									<div className='grid grid-cols-1 md:grid-cols-5 gap-3'>
										<div className='md:col-span-2'>
											...
											<Input
												value={template.name}
												onChange={(e: { target: { value: any } }) => setIncomeTemplates((curr) => curr.map((item, i) => (i === index ? { ...item, name: e.target.value } : item)))}
										...
										<div>
											...
											<select
												...
												onChange={(e) => setIncomeTemplates((curr) => curr.map((item, i) => (i === index ? { ...item, scheduleType: e.target.value as ScheduleType } : item)))}
											>
										...
										<div>
											...
											<select
												...
												onChange={(e) => setIncomeTemplates((curr) => curr.map((item, i) => (i === index ? { ...item, isActive: e.target.value === 'active' } : item)))}
											>
										...
										{template.scheduleType === 'monthly' ? (
											<div>
												...
												<Input
													...
													onChange={(e: { target: { value: any } }) =>
														setIncomeTemplates((curr) => curr.map((item, i) => (i === index ? { ...item, monthlyDayOfMonth: Number(e.target.value || 1) } : item)))
													}
												/>
											</div>
										) : null}
											...
											<>
												<div>
													...
													<Input
														...
														onChange={(e: { target: { value: any } }) =>
															setIncomeTemplates((curr) => curr.map((item, i) => (i === index ? { ...item, semiMonthlyDay1: Number(e.target.value || 1) } : item)))
														}
												...
												<div>
													...
													<Input
														...
														onChange={(e: { target: { value: any } }) =>
															setIncomeTemplates((curr) => curr.map((item, i) => (i === index ? { ...item, semiMonthlyDay2: Number(e.target.value || 15) } : item)))
														}
														className={attemptedSave && errors.semiMonthlyDays ? 'border-destructive' : ''}
													/>
									...
									<div className='grid grid-cols-1 md:grid-cols-5 gap-3'>
										...
										<div>
											...
											<Input
												...
												onChange={(e: { target: { value: any } }) =>
													setCategoryTemplates((curr) => curr.map((item, i) => (i === index ? { ...item, allocation: Number(e.target.value || 0) } : item)))
												}
