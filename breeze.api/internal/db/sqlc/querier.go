...
type Querier interface {
	...
	CreateFinancialOrderSteps(ctx context.Context, userID uuid.UUID) ([]Goal, error)
	...
	LinkAssetToPlaidAccount(ctx context.Context, arg LinkAssetToPlaidAccountParams) (int64, error)
	LinkLiabilityToPlaidAccount(ctx context.Context, arg LinkLiabilityToPlaidAccountParams) (int64, error)
	...
	ListFinancialOrderStepsByUserID(ctx context.Context, userID uuid.UUID) ([]Goal, error)
	...
	SoftDeleteBudget(ctx context.Context, arg SoftDeleteBudgetParams) (int64, error)
	SoftDeleteExpense(ctx context.Context, arg SoftDeleteExpenseParams) (int64, error)
	SoftDeleteExpenseCategory(ctx context.Context, arg SoftDeleteExpenseCategoryParams) (int64, error)
	...
	SoftDeleteGoal(ctx context.Context, arg SoftDeleteGoalParams) (int64, error)
	SoftDeleteIncome(ctx context.Context, arg SoftDeleteIncomeParams) (int64, error)
	SoftDeleteLiability(ctx context.Context, arg SoftDeleteLiabilityParams) (int64, error)
	...
	SoftDeleteRecurringIncome(ctx context.Context, arg SoftDeleteRecurringIncomeParams) (int64, error)
	...
	UnlinkAssetFromPlaidAccount(ctx context.Context, arg UnlinkAssetFromPlaidAccountParams) (int64, error)
	UnlinkLiabilityFromPlaidAccount(ctx context.Context, arg UnlinkLiabilityFromPlaidAccountParams) (int64, error)
	...
	UpdateUserSetup(ctx context.Context, arg UpdateUserSetupParams) (User, error)
