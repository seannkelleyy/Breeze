...
- Product and engineering docs live in `.github/docs/`
- Agent execution rules live in `.github/instructions.md` and `.github/copilot-instructions.md`
...
- `ui/recurring-budget-generation-spec.md`
